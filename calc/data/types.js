...
var XY = util_1.extend(true, {}, GSC, {
    '???': { Fairy: 1, Ruined: 1 },
    Normal: { Fairy: 1, Ruined: 0.5 },
    Grass: { Fairy: 1, Ruined: 0.5 },
    Fire: { Fairy: 1, Ruined: 0.5 },
    Water: { Fairy: 1, Ruined: 0.5 },
    Electric: { Fairy: 1, Ruined: 0.5 },
    Ice: { Fairy: 1, Ruined: 0.5 },
    Flying: { Fairy: 1, Ruined: 0.5 },
    Bug: { Fairy: 0.5, Ruined: 0.5 },
    Poison: { Fairy: 2, Ruined: 0.5 },
    Ground: { Fairy: 1, Ruined: 0.5 },
    Rock: { Fairy: 1, Ruined: 0.5 },
    Fighting: { Fairy: 0.5, Ruined: 0.5 },
    Psychic: { Fairy: 1, Ruined: 0.5 },
    Ghost: { Steel: 1, Fairy: 1, Ruined: 0.5 },
    Dragon: { Fairy: 0, Ruined: 0.5 },
    Dark: { Steel: 1, Fairy: 0.5, Ruined: 0.5 },
    Steel: { Fairy: 2, Ruined: 0.5 },
    Fairy: {
        '???': 1,
        Normal: 1,
        Grass: 1,
